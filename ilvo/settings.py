"""
Django settings for ilvo project.
...
WSGI_APPLICATION = 'ilvo.wsgi.application'
...
# Enabling channels with Daphne
# https://channels.readthedocs.io/
ASGI_APPLICATION = "ilvo.asgi.application"
